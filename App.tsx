...
const VerifyEmailPage = React.lazy(() => import('./pages/AccountManagement/VerifyEmailPage'));
const VerifyPhonePage = React.lazy(() => import('./pages/AccountManagement/VerifyPhonePage'));
const SigninPage = React.lazy(() => import('./pages/SigninPage'));
const HelpPage = React.lazy(() => import('./pages/HelpPage'));
const ForgotPasswordPage = React.lazy(() => import('./pages/AccountManagement/ForgotPasswordPage'));
const ResetPasswordPage = React.lazy(() => import('./pages/AccountManagement/ResetPasswordPage'));
...
const AccountServicesPage = React.lazy(() => import('./pages/AccountManagement/AccountServicesPage'));
...
const SecurityPage = React.lazy(() => import('./pages/AccountManagement/SecurityPage'));
const TwoFactorSetupPage = React.lazy(() => import('./pages/AccountManagement/TwoFactorSetupPage'));
const DevicesPage = React.lazy(() => import('./pages/AccountManagement/DevicesPage'));
const ProfilePage = React.lazy(() => import('./pages/AccountManagement/ProfilePage'));
const SecuritySettingsPage = React.lazy(() => import('./pages/AccountManagement/SecuritySettingsPage'));
const DeviceManagementPage = React.lazy(() => import('./pages/AccountManagement/DeviceManagementPage'));
const PrivacySettingsPage = React.lazy(() => import('./pages/AccountManagement/PrivacySettingsPage'));
const NotificationPreferencesPage = React.lazy(() => import('./pages/AccountManagement/NotificationPreferencesPage'));
const PaymentMethodsPage = React.lazy(() => import('./pages/AccountManagement/PaymentMethodsPage'));
const OrderHistoryPage = React.lazy(() => import('./pages/AccountManagement/OrderHistoryPage'));
const ConnectedAppsPage = React.lazy(() => import('./pages/AccountManagement/ConnectedAppsPage'));
const ActivityLogsPage = React.lazy(() => import('./pages/AccountManagement/ActivityLogsPage'));
const AccountDashboardPage = React.lazy(() => import('./pages/AccountManagement/AccountDashboardPage'));
const WishlistPage = React.lazy(() => import('./pages/AccountManagement/WishlistPage'));
const CartPage = React.lazy(() => import('./pages/AccountManagement/CartPage'));
const WalletPage = React.lazy(() => import('./pages/AccountManagement/WalletPage'));
const SubscriptionsPage = React.lazy(() => import('./pages/AccountManagement/SubscriptionsPage'));
const AddressesPage = React.lazy(() => import('./pages/AccountManagement/AddressesPage'));
const RewardsPage = React.lazy(() => import('./pages/AccountManagement/RewardsPage'));
const PreferencesPage = React.lazy(() => import('./pages/AccountManagement/PreferencesPage'));
